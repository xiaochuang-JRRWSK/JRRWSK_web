...
"philosophy":"哲学","law":"法学","others":"其他"}
...
class Text:
    ...
    def lecture_introduction_generate(self):
        ...
        try:
            try:
                ...
                txt = str(self.start_time)+"由"+self.person_name+"主讲,讲座主题为"+self.title+"。"
        except IndexError:
            txt = "讲座信息不全。"
    ...
    def introduction_generate(self):
        ...
        self.introduction = "<br>【讲座介绍】"+lecture_introduction + "<br>【讲座人介绍】"+person_intorduction
